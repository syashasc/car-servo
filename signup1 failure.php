...
<div class="jumbotron">
  ...
  <div class="login-form">
      <form action="signup.php" method="POST">
		...
		<div class="form-group">
            <input type="text" class="form-control" placeholder="Car Number" required="required" name="Car_no">
        </div>
		<div class="form-group">
            <input type="text" class="form-control" placeholder="Car type" required="required" name="Car_type">
        </div>
